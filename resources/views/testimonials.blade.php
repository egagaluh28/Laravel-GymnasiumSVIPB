...
<div class="section big-55-height over-hide z-bigger">
    ...
    <div class="parallax parallax-top" style="background-image: url('img/logos/testi.jpg')"></div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 parallax-fade-top">
                    <div class="hero-text">Testimoni</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">	
                <h5 class="color-grey">Jelajahi Kemewahan Baru dalam Dunia Kebugaran.</h5>
...
<div class="section padding-top-bottom-big over-hide">
    <div class="parallax" style="background-image: url('img/logos/basket.jpg')"></div>
