...
@section('container')
    <div class="section big-55-height over-hide z-bigger">
        ...
        <div class="parallax parallax-top" style="background-image: url('img/logos/s&k.jpg')"></div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 parallax-fade-top">
                        <div class="hero-text">Syarat &amp; Ketentuan</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThree">
                                <h5 class="m-0">
                                    <button class="btn btn-link last collapsed" data-toggle="collapse"
